...
[native adapter guide](docs/native-adapters.md) for selectors and examples.

## Public experiment to neural surrogate

The [CuSn8Ni2 tensile example](examples/kupfer_tensile/README.md) runs public
...
Its [verification record](docs/verification/2026-09-06-public-tensile-surrogate.md)
...
4.428 MPa and 4.477 MPa. The [reference INP](examples/kupfer_tensile/reference/base.inp)
and [result summary](docs/verification/assets/public-tensile-20260906/summary.json)
accompany the case.

![CuSn8Ni2 experiment, FE and neural surrogate comparison](docs/verification/assets/public-tensile-20260906/experimental-workflow.png)
...
Project-wide license selection awaits the owner's decision. Public-source
manifests record the licenses of their respective sources.
